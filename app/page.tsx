  ...
  return (
    <div ref={containerRef} className="min-h-screen">
      ...
      <MemoizedSectionTransition className="min-h-screen flex items-center py-20 px-4 md:px-10">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              <MemoizedAnimatedHeading text="About Me" className="text-4xl md:text-5xl font-light mb-8 text-gradient" />
              ...
              >
                <p>
                  ...
                  media buying. My expertise spans across programmatic advertising, performance marketing, and strategic
                  campaign management for global brands.
                </p>
                <p>
      ...
      <MemoizedSectionTransition className="py-20 px-4 md:px-10">
        <div className="container mx-auto max-w-6xl">
          <div className="flex justify-between items-center mb-12">
            <MemoizedAnimatedHeading text="Latest Insights" className="text-3xl md:text-4xl font-light text-gradient" />
            <Link href="/blog">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <button onClick={handleCertificateClose} className="text-gray-400 hover:text-white transition-colors">
                    <X className="h-6 w-6" />
                  </button>
                </div>
