          ...
          <>
            {actions.map((action, i) => (
              <motion.button
                ...
                className={`${action.color} p-3 rounded-full shadow-lg flex items-center gap-2 min-w-[120px] justify-center hover:bg-white/10 transition-colors relative overflow-hidden`}
                whileHover={{
                  scale: 1.05,
                  x: -5,
